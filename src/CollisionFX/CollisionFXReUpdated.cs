...
namespace CollisionFXReUpdated
{
	public class CollisionFX : PartModule
	{
		public static string ConfigPath = "GameData/CollisionFXReUpdated/settings.cfg";
		...
		private readonly GameObject sparkFx;
		private GameObject _sparkFX;
		private readonly ParticleSystem sparkFxParticleEmitter;
		...
		private readonly Light scrapeLight;
    ...
    internal class ColourManager
    {
        internal static Color GenericDustColour;

        internal static Color GetDustColour(string colliderName)
        {
