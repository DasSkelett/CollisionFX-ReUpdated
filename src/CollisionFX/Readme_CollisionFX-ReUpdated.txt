-------------------------------------------------------------
 Collision FX-ReUpdated 
 Author:    VoidCosmos
 Version:   1.0.0.0
 Released:  2020-05-12
 KSP:       v1.9.1

 Thread:    https://forum.kerbalspaceprogram.com/index.php?/topic/193803-19x-collisionfx-reupdated/
 Licence:   GNU v2, http://www.gnu.org/licenses/gpl-2.0.html
 Downloads: Spacedock: Coming Soon
			Github: Comming Soon
-------------------------------------------------------------
...
---------------
1.0.0.0 (2020/05/13)
- Recompiled for KSP 1.9.X
- Adopted by a new Author (a.k.a VoidCosmos)
- Updated .dll to .net 4.X
- Few bugfixes
- Should work in KSP 1.8.X (use at your own risk)
- Renamed to Collision FX-ReUpdated
